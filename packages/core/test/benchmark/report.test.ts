 ...
 *   Recall@1 = 7/9 = 0.777778 (case-ambiguity-02 and case-distractors-01
 *   both have their first relevant id at rank 2)
 *   Recall@3 = Recall@5 = 1.000000
 *   Precision@1 = 7/9 = 0.777778; Precision@3 = 9 x (1/3) / 9 = 0.333333;
 *   Precision@5 = 9 x (1/5) / 9 = 0.200000 (denominator is k)
 *   MRR = (7 x 1 + 2 x 1/2) / 9 = 8/9 = 0.888889
...
const expectedReport =
  [
    ...
    "case-temporal-02    cat=temporal         pass=1 abst=0 exp=0 ret=2 stale=1 forb=0 sup=1 chars=179 lat=10ns R@1=1.000000 R@3=1.000000 R@5=1.000000 P@1=1.000000 P@3=0.333333 P@5=0.200000 RR=1.000000",
    ...
    "Recall@1=0.777778 Recall@3=1.000000 Recall@5=1.000000",
    "Precision@1=0.777778 Precision@3=0.333333 Precision@5=0.200000",
    "MRR=0.888889",
...
describe("renderReport", () => {
  ...
  it("rounds aggregates once at report time (6 decimals)", () => {
    ...
    expect(report).toContain("MRR=0.888889");
